      ...
      <div className="w-full md:w-1/3 text-left">
        ...
        >
          <a
            ...
            className="font-general-medium flex justify-center items-center w-48 sm:w-64 mt-12 mb-6 sm:mb-0 text-lg border border-indigo-200 dark:border-ternary-dark py-2.5 sm:py-3 shadow-lg rounded-lg bg-indigo-600 hover:bg-indigo-700 text-white focus:ring-1 focus:ring-indigo-900 duration-500"
            aria-label="Download Resume"
          >
            <FiArrowDownCircle className="ml-0 sm:ml-1 mr-2 sm:mr-3 h-5 w-5 sn:w-6 sm:h-6 duration-100"></FiArrowDownCircle>
            <span className="text-sm sm:text-lg duration-100 whitespace-nowrap">Download Resume</span>
          </a>
        </motion.div>
      </div>
      <motion.div
