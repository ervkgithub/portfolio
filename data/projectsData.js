...
export const projectsData = [
      ...
      CompanyInfo: [
        {
          ...
          title: "SafeWebKey",
          details:
            "SafeWebKey is a user-friendly concept that allows the user to log on to any website availing of the SafeWebKey technology. The great thing is that the user can use the same username and password, without having to register, on the individual website. However, before you can get started you will have to get verified, once and for all. The technology requires that the user downloads the SafeWebKey mobile app. Once up and running a OTP (One time password ) will be shown in the app, and the user can log on the the website.",
        },
        {
          id: uuidv4(),
          title: "Android Play Store URL",
          details: "https://apkpure.net/safewebkey/com.safewebkey.app",
        },
      ],
      Technologies: [
        {
      ...
      CompanyInfo: [
        {
          ...
          title: "ParkGenie",
          details:
            "Empowering facility owners and drivers save time and money across Europe since 2008. At Park Genie, we deliver easy to use and cost efficient digital IoT based parking and access management solutions through a customizable, flexible and scalable platform which seamlessly integrates with your existing infrastructure. These end-to-end solutions are designed to strengthen security, improve parking detection and guidance, enhance communication in turn reducing congestion and saving time and money.",
        },
        {
          id: uuidv4(),
          title: "Website",
    ...
    ProjectInfo: {
      ...
      CompanyInfo: [
        ...
        },
        {
          ...
          title: "Website",
          details:
            "https://play.google.com/store/apps/details?id=com.uweens.parkgenie.pu&pcampaignid=web_share",
        },
      ],
      Technologies: [
        {
    ...
    ProjectInfo: {
      ...
      CompanyInfo: [
        ...
        },
        {
          ...
          title: "Website",
          details:
            "https://play.google.com/store/apps/details?id=com.uweens.parkgenie.psp&pcampaignid=web_share",
        },
      ],
      Technologies: [
        {
  ...
  },
  {
    id: 9,
    title: "Hoganlovells",
    url: "https://www.hoganlovells.com/en",
    category: "Web Application",
    img: "/images/hl.png",
    ProjectHeader: {
      title: "Hogan lovells legal",
      publishDate: "Jan 10, 2024",
      tags: "UI / Frontend",
    },
    ProjectImages: [
      {
        id: uuidv4(),
        title: "Hogan Lovells or the firm refers to the international legal practice of Hogan Lovells LLP",
        img: "/images/hl.png",
      },
    ],
    ProjectInfo: {
      ...
      CompanyInfo: [
        ...
        },
        {
          id: uuidv4(),
          title: "Website",
          details: "https://www.hoganlovells.com/en",
        },
      ],
      Technologies: [
        {
